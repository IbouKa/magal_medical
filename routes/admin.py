...
'CS_DAROU_MARNANE_SU2': 'Pènthe Darou Marnane',
    ...
    'CS_TOUBA_NDIAREME_SU_POSTE':'AAAA', 
    'PS_DAROU_KARIM_SU1':'PS DAROU KARIM', 
    'PS_ALIEU_SU1':'PS ALIEU', 
    'PS_KHAIRA_SU2':'Pènthe Khaïra', 
    'PS_MBOUSSOBE_SU2':'Case de santé Solbock', 
    'CS_SERIGNE_SALIOU_MBACKE_EX_28_SU_POSTE':'CS SERIGNE SALIOU MBACKE EX 28', 
    'CS_TOUBA_NDAME_SU_POSTE':'CS TOUBA NDAME', 
    'CS_SAYDIL_BADAWI_SU1':'CS SAYDIL BADAWI', 
    'CS_TOUBA_NDAME_SU2':'AAAA', 
    'AAA':'AAAA', 
    'AAA':'AAAA', 
    'AAA':'AAAA', 
    'AAA':'AAAA', 
